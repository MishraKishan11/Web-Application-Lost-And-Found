...
<div class ="left">
    <form action="ReportCode.jsp">
    
        <table border ="0" width="50%" cellspacing="10" cellpadding="" >
          <tr bgcolor ="white" ALIGN ="center">
            <td colspan="4" style="color: white;font-size:15px;font-family:arial;background-color:black;border-radius:200px">FOUND REPORT</td>
        </tr>  
         <tr>
        ...
        <td   class="table">Date</td>
          ...
          <tr bgcolor ="" Align ="center">
            ...
            <td  class="table">Address(Where you found lost one)</td>
