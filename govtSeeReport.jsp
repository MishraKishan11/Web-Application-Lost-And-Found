...
nav{
   ...
   <body background="family.jpeg" >
    ...
    <table width="100%" align="center" cellspacing="20" border="5px solid blue;"class="comtable" >
        <tr align="center">
            <td colspan="11" style="color: black;font-size:15px;font-family:arial;background-color:white;border-radius:200px">FOUND-TABLE</td>
        </tr>
        <tr class="comrow" >
    ...
    <h1  >Delete Report</h1>
    <form action="DeleteReportCode.jsp">
